...
//        createBox(world,300*M_PER_PIXEL,14f,150,150);
        ...
        createBox(world, 400f*M_PER_PIXEL,400f,50,50);
        createBox(world, 400f*M_PER_PIXEL,350f,50,50);
        createBox(world, 400f*M_PER_PIXEL,300f,50,50);
        createBox(world, 400f*M_PER_PIXEL,250f,50,50);
