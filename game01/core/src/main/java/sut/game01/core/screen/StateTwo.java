...
public class StateTwo extends Screen {
    ...
    public void wasAdded(){
        ...
        blocks.add(new Block(world,440f,400f,25f,190f));
        blocks.add(new Block(world,390f,400f,25f,120f));
        blocks.add(new Block(world,340f,400f,25f,50f));
        blocks.add(new Block(world,290f,400f,25f,50f));
        blocks.add(new Block(world,315f,375f,75f,20f));
        blocks.add(new Block(world,340f,330f,25f,50f));
        blocks.add(new Block(world,365f,310f,75f,20f));
        blocks.add(new Block(world,390f,260f,25f,50f));
        blocks.add(new Block(world,415f,235f,75f,20f));
        for (Block nb:blocks){
            layer.add(nb.layer());
        }
