 ...
 */
public class StateFour extends Screen {
    ...
    public StateFour(ScreenStack ss){
        this.ss = ss;
    }
    ...
    public void wasAdded(){
        ...
        blocks.add(new Block(world,400f,360f,25f,40f));
        blocks.add(new Block(world,400f,310f,50f,50f));
        blocks.add(new Block(world,400f,270f,25f,40f));

        blocks.add(new Block(world,320f,400f,50f,50f));
        blocks.add(new Block(world,320f,360f,25f,40f));
        blocks.add(new Block(world,320f,310f,50f,50f));
        blocks.add(new Block(world,320f,270f,25f,40f));
        blocks.add(new Block(world,320f,220f,50f,50f));
        blocks.add(new Block(world,320f,180f,25,40f));
